...
<?php if ($prev || $next): ?>
  <div class="forum-topic-navigation clear-block">
    <?php if ($prev): ?>
      ...
      <a href="<?php print $prev_url; ?>" class="readon prev" title="<?php print t('Go to previous forum topic') ?>"><span> &laquo; <?php print $prev_title ?></span></a>
    <?php endif; ?>
    <?php if ($next): ?>
     <a href="<?php print $next_url; ?>" class="readon next" title="<?php print t('Go to next forum topic') ?>"><span><?php print $next_title ?> &raquo;</span></a>
    <?php endif; ?>
  </div>
<?php endif; ?>
